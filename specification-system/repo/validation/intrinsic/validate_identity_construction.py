    ...
    if references["mode"] != "none":
        ...
        for index, raw_item in enumerate(raw_items):
            ...
            if references["mode"] == "by-identity":
                ...
                processed.append({"identity": identity, "value": embedded})
