...
ARTIFACT_CLASSES = (
    ...
    "identity-authority-construction",
    ...
    "validation-fixtures-construction",
...
REQUIRED_PATHS = (
    ...
    "validation/intrinsic/validate_portable.py",
    ...
    "validation/tests/test_repository_completeness.py",
    "validation/tests/test_portable_instance.py",
